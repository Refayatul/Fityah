<div align="center">
  <img src="fastlane/metadata/android/en-US/images/icon.png" style="width: 30%;" />
   ...
   [![GitHub contributors](https://img.shields.io/github/contributors/Refayatul/Fityah)](https://github.com/Refayatul/Fityah/graphs/contributors)
   ...
   [![Telegram Group](https://img.shields.io/badge/Telegram%20Group-blue?style=flat&logo=telegram)](https://t.me/fityahapp)

</div>

Fityah is a powerful open source utility for Android built to help you reclaim your time and master your digital habits. It provides a suite of tools designed to break the cycle of screen addiction through granular control and deep insights.

<div align="center">
<table>
	<tr>
		<td><a href="https://trendshift.io/repositories/14634?utm_source=repository-badge&amp;utm_medium=badge&amp;utm_campaign=badge-repository-14634" target="_blank" rel="noopener noreferrer"><img src="https://trendshift.io/api/badge/repositories/14634" alt="fityah-app%2Ffityah-android | Trendshift" width="250" height="55"/></a></td>
		<td><a href="https://trendshift.io/repositories/14634?utm_source=trendshift-badge&amp;utm_medium=badge&amp;utm_campaign=badge-trendshift-14634" target="_blank" rel="noopener noreferrer"><img src="https://trendshift.io/api/badge/trendshift/repositories/14634/daily?language=Kotlin" alt="fityah-app%2Ffityah-android | Trendshift" width="250" height="55"/></a></td>
	</tr>
</table>
</div>
...
### Why Fityah Stands Out

Most screen time tools are closed source. This raises concerns about your private usage data being tracked or sold. Fityah takes a different path.
...
### How to install
[Please read the docs for step by step instructions](https://fityah.app/docs)


 <p>
    <a href="https://f-droid.org/packages/com.refayatul.fityah"><img src="https://fdroid.gitlab.io/artwork/badge/get-it-on.png" alt="Get it on F-Droid" height="80"></a>
    <a href="https://github.com/Refayatul/Fityah/releases/latest"><img src="https://raw.githubusercontent.com/andOTP/andOTP/master/assets/badges/get-it-on-github.png" height="80"></a>
   </p>
...
Fityah goes beyond simple app timers. It targets the specific triggers that lead to mindless scrolling.

#### Blocking & Control
- **App & Website Blocking:** Block distracting apps and websites completely.
- **Tamper Protection:** Make it difficult to uninstall Fityah and changing configurations.
...
#### For Developers
- **[Fityah API](FITYAH_API.md):** Let your apps directly interact with Fityah and start focus modes, change settings, get usage stats, etc. Requires user permission

### Contributing

We welcome contributions from the community! If you want to help improve Fityah, please follow these steps:
...
Fityah is licensed under the GPL 3 or later license. You are free to use, modify, and distribute this software in accordance with the license.
