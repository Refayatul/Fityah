...
/**
 * Billing state for builds that sell sync. Everything in Fityah is free except
...
const val SYNCED_WEB_PACKAGE = "__fityah_synced_web__"

/** Internal selection marker for "no remote devices"; empty keeps its existing "all" meaning. */
const val NO_SYNC_USAGE_DEVICE = "__fityah_no_sync_usage_device__"
