...
import com.refayatul.fityah.data.db.ReelStatsDao
import com.refayatul.fityah.data.db.ReelStatsEntity
import com.refayatul.fityah.data.models.ReelCounterOverlayConfig
...
class ReelsCountTracker {
    ...
    companion object {
        const val INTENT_ACTION_REFRESH_REEL_COUNTER = "com.refayatul.fityah.refresh.reel_counter"
    }
