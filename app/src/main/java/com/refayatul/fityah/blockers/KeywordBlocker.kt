...
import com.refayatul.fityah.utils.ActiveTimeGroupWindow
...
class KeywordBlocker : BaseBlocker() {
    companion object {
        const val INTENT_ACTION_REFRESH_CONFIG = "com.refayatul.fityah.refresh.keywordblocker.config"
        const val INTENT_ACTION_REFRESH_KEYWORD_BLOCKER_COOLDOWN = "com.refayatul.fityah.refresh.keywordblocker.cooldown"
