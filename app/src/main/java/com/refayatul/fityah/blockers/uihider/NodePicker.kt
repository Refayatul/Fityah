 ...
 * [com.refayatul.fityah.hardcoded.ReelAppConfig] uses, so it can be pasted into a UIHider script.
 *
...
class NodePicker : BaseBlocker(), NodePickerOverlay.Listener {
    ...
    companion object {
        const val ACTION_OPEN = "com.refayatul.fityah.nodepicker.OPEN"
        const val ACTION_STOP = "com.refayatul.fityah.nodepicker.STOP"
