...
import com.refayatul.fityah.hardcoded.URL_BAR_ID_LIST
import com.refayatul.fityah.services.AppBlockerService
import com.refayatul.fityah.services.BaseBlockingService
import com.refayatul.fityah.utils.AppSuspendHelper
import com.refayatul.fityah.utils.TimerNotification
import com.refayatul.fityah.utils.getCurrentKeyboardPackageName
...
class FocusModeBlocker : BaseBlocker() {
    ...
    companion object {
        const val INTENT_ACTION_REFRESH_FOCUS_MODE = "com.refayatul.fityah.refresh.focus_mode"
        const val INTENT_ACTION_UNSUSPEND_ALL = "com.refayatul.fityah.unsuspend_all_apps"
    }
    ...
    private fun turnOffFocusMode() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            if (groupId != null) {
                val db = com.refayatul.fityah.data.db.AppDatabase.getInstance(service)
     ...
     */
    private suspend fun applySettings(settings: com.refayatul.fityah.data.models.Settings) {
