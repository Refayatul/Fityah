...
/**
 * The public contract for the Fityah API.
 *
 * Other apps bind to [FityahApiService] over AIDL ([IFityahApi]) and drive Fityah with the command
...
/** Actions a client can run through execute(). Each command's args are documented in FITYAH_API.md. */
