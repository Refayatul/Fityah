...
import com.refayatul.fityah.data.models.ManualFocusGroup
import com.refayatul.fityah.data.models.PendingSettingsChange
import com.refayatul.fityah.data.models.Settings
import com.refayatul.fityah.data.models.SettingsChangeDelayConfig
import com.refayatul.fityah.data.models.SettingsChangeDelayPrefs
import com.refayatul.fityah.data.models.upgradeLegacyAppGroupConfigs
import com.refayatul.fityah.data.models.upgradeLegacyKeywordGroupConfigs
import com.refayatul.fityah.data.models.upgradeLegacyConfig
import com.refayatul.fityah.hardcoded.normalized
import com.refayatul.fityah.services.TemporaryGroupDisableJob
import java.io.File
...
class DataStoreManager(private val context: Context) {
    ...
    suspend fun updateAutoDndGroups(newGroups: List<com.refayatul.fityah.data.models.AutoDndGroup>) {
    ...
    suspend fun updateReelBlockerConfig(config: com.refayatul.fityah.data.models.ReelBlocker) {
        updateGated(GatedSettingsField.REEL_BLOCKER) { config.upgradeLegacyConfig(gson) }
    }

    suspend fun updateKeywordBlockerConfig(transform: (com.refayatul.fityah.data.models.KeywordBlocker) -> com.refayatul.fityah.data.models.KeywordBlocker) {
    ...
    suspend fun updateGrayscaleGroups(newGroups: List<com.refayatul.fityah.data.models.GrayscaleGroup>) {
    ...
    suspend fun updateMindfulMessageConfig(config: com.refayatul.fityah.data.models.MindfulMessageConfig) {
        updateGated(GatedSettingsField.MINDFUL_MESSAGES) { config }
    }

    suspend fun updateUiHiderConfig(transform: (com.refayatul.fityah.data.models.UiHiderConfig) -> com.refayatul.fityah.data.models.UiHiderConfig) {
        updateGated(GatedSettingsField.UI_HIDER) { transform(it.uiHiderConfig.normalized()) }
    }

    suspend fun updateReelCounterOverlayConfig(config: com.refayatul.fityah.data.models.ReelCounterOverlayConfig) {
        settingsDataStore.updateData { it.copy(reelCounterOverlayConfig = config) }
    }

    suspend fun updateVpnConfig(config: com.refayatul.fityah.data.models.VpnConfig) {
        updateGated(GatedSettingsField.VPN) { config }
    }

    suspend fun updateTrustedContact(name: String, email: String) {
        settingsDataStore.updateData { it.copy(trustedContactName = name, trustedContactEmail = email) }
    }

    suspend fun updateGuardianPinHash(hash: String?) {
        settingsDataStore.updateData { it.copy(guardianPinHash = hash) }
    }
    ...
    suspend fun updateAntiUninstallConfig(transform: (com.refayatul.fityah.data.models.AntiUninstallConfig) -> com.refayatul.fityah.data.models.AntiUninstallConfig) {
    ...
    suspend fun updateServiceProtectionConfig(transform: (com.refayatul.fityah.data.models.ServiceProtectionConfig) -> com.refayatul.fityah.data.models.ServiceProtectionConfig) {
    ...
    suspend fun temporarilyDisableAppGroup(groupId: String, durationMinutes: Long): Boolean {
        ...
        if (changed) {
            com.refayatul.fityah.services.TemporaryGroupDisableJob.schedule(context, nextDeadline)
        }
        return changed
    }
    ...
    private suspend fun schedulePendingChanges() {
        ...
        com.refayatul.fityah.services.PendingSettingsChangeJob.schedule(
        ...
        return runCatching {
            when (field) {
                ...
                GatedSettingsField.AUTO_DND_GROUPS -> settings.copy(
                    autoDndGroups = gson.fromJson(valueJson, object : TypeToken<List<com.refayatul.fityah.data.models.AutoDndGroup>>() {}.type)
                )
                GatedSettingsField.REEL_BLOCKER -> settings.copy(
                    reelBlockerConfig = gson.fromJson(valueJson, com.refayatul.fityah.data.models.ReelBlocker::class.java)
                        .upgradeLegacyConfig(gson)
                )
                GatedSettingsField.KEYWORD_BLOCKER -> settings.copy(
                    keywordBlockerConfig = gson.fromJson(
                        valueJson,
                        com.refayatul.fityah.data.models.KeywordBlocker::class.java
                ...
                GatedSettingsField.GRAYSCALE_GROUPS -> settings.copy(
                    grayscaleGroups = gson.fromJson(valueJson, object : TypeToken<List<com.refayatul.fityah.data.models.GrayscaleGroup>>() {}.type)
                )
                GatedSettingsField.MINDFUL_MESSAGES -> settings.copy(
                    mindfulMessageConfig = gson.fromJson(valueJson, com.refayatul.fityah.data.models.MindfulMessageConfig::class.java)
                )
                GatedSettingsField.UI_HIDER -> settings.copy(
                    uiHiderConfig = gson.fromJson(valueJson, com.refayatul.fityah.data.models.UiHiderConfig::class.java)
                )
                GatedSettingsField.VPN -> settings.copy(
                    vpnConfig = gson.fromJson(valueJson, com.refayatul.fityah.data.models.VpnConfig::class.java)
                )
    ...
    private fun syncedFieldValueJson(settings: Settings, field: GatedSettingsField): String? =
        runCatching {
            val value: Any = when (field) {
                ...
                GatedSettingsField.VPN -> settings.vpnConfig
     ...
     * from the Fityah API while the app is in the background.
     */
    private fun notifyChangeDeferred(
        ...
        Handler(Looper.getMainLooper()).post {
            try {
                val intent = Intent(appContext, com.refayatul.fityah.ui.activity.PendingChangeReviewActivity::class.java).apply {
                    addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                    putExtra(com.refayatul.fityah.ui.activity.PendingChangeReviewActivity.EXTRA_FIELD, field.name)
                    putExtra(com.refayatul.fityah.ui.activity.PendingChangeReviewActivity.EXTRA_APPLIES_AT_MS, appliesAtMs)
                    putExtra(com.refayatul.fityah.ui.activity.PendingChangeReviewActivity.EXTRA_REPLACED_EXISTING, replacedExisting)
                    putExtra(com.refayatul.fityah.ui.activity.PendingChangeReviewActivity.EXTRA_TAMPER_GATED, tamperGated)
                }
