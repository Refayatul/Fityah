...
import com.refayatul.fityah.utils.scheduleConflictsWith
...
class AppBlockerGroupsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.btn_help).setOnClickListener {
            ViewUtils.showHelpPopup(it, "Block distracting apps and regain control over your screen time.", "https://fityah.app/docs/reducers/app-pause/")
        }
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            if (group.temporarilyDisabledUntilMs == TemporaryDisableDialog.UNTIL_MANUALLY_ENABLED) {
                ...
                holder.tvRemaining.text = getString(
                    ...
                    com.refayatul.fityah.utils.SettingsChangeDelayUtils.formatRemaining(
                        requireContext(),
                        temporaryRemaining
                    )
                )
