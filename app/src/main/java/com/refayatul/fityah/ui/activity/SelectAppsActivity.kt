...
import com.refayatul.fityah.databinding.ActivitySelectAppsBinding
import com.refayatul.fityah.databinding.DialogAddKeywordBinding
...
class SelectAppsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ignoredApps.add(packageName) // also remove fityah app from the list
