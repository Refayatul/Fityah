...
import com.refayatul.fityah.databinding.ReelBlockerFragmentBinding
import com.refayatul.fityah.hardcoded.ReelAppConfig
import com.refayatul.fityah.ui.activity.SelectAppsActivity
import com.refayatul.fityah.utils.SettingsChangeDelayUtils
import com.refayatul.fityah.utils.TemporaryDisableDialog
...
class ReelBlockerFragment : Fragment() {
    ...
    private fun setupListeners() {
        ...
        binding.btnWarningConfig.setOnClickListener {
            val configFragment = com.refayatul.fityah.ui.fragments.main.reducers.blockertools.shared.WarningConfigFragment.newInstance(viewModel.reelBlockerConfig.value.warningScreenConfig, "result_warning_config_reel")
        ...
        parentFragmentManager.setFragmentResultListener("result_warning_config_reel", viewLifecycleOwner) { _, bundle ->
            ...
            if (configStr != null) {
                viewModel.updateWarningConfig(com.google.gson.Gson().fromJson(configStr, com.refayatul.fityah.data.models.AppBlockerWarningScreenConfig::class.java))
            }
        }
