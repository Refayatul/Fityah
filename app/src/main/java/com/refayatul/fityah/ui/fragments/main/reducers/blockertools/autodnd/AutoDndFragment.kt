...
import com.refayatul.fityah.databinding.FragmentAutodndBinding
import com.refayatul.fityah.databinding.ItemAutodndGroupBinding
...
class AutoDndFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.fabAddGroup.setOnClickListener {
            val intent = Intent(requireContext(), com.refayatul.fityah.ui.activity.FragmentActivity::class.java).apply {
        ...
        binding.btnHelp.setOnClickListener {
            ViewUtils.showHelpPopup(it, "Automatically silence notifications during your focus sessions.", "https://fityah.app/docs/reducers/auto-dnd/")
        }
