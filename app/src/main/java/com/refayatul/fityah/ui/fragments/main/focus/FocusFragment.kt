...
class FocusFragment : Fragment() {
    ...
    private fun setupClicks() {
        ...
        binding.btnHelp.setOnClickListener {
            ViewUtils.showHelpPopup(it, "Focus mode helps you stay away from distractions for a set period of time.", "https://fityah.app/docs/focus/focus-mode/")
        }
    ...
    private fun showWriteFocusNfcDialog() {
        ...
        dialog.setOnShowListener {
            ...
            dialog.getButton(android.app.AlertDialog.BUTTON_POSITIVE).setOnClickListener {
                ...
                val uri = buildString {
                    append("fityah://focus/").append(action)
    ...
    /** Enables reader mode, reads a fityah://focus URI from the tapped tag, and hands it to [onLoaded]. */
    private fun startFocusNfcLoad(onLoaded: (android.net.Uri) -> Unit) {
        ...
        val enabled = NfcUnlockUtils.enableReader(activity) { tag ->
            ...
            if (uri != null && uri.scheme == "fityah" && uri.host == "focus") {
                onLoaded(uri)
