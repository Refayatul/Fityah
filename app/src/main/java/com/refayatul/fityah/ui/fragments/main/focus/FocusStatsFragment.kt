...
import com.refayatul.fityah.databinding.FragmentFocusStatsBinding
...
class FocusStatsFragment : Fragment() {
    ...
    private fun updateWeeklyGraph(sessions: List<FocusStatsEntity>) {
        val days = mutableListOf<com.refayatul.fityah.ui.views.WeeklyBarGraphView.DayData>()
        ...
        for (i in 6 downTo 0) {
            ...
            days.add(com.refayatul.fityah.ui.views.WeeklyBarGraphView.DayData(
