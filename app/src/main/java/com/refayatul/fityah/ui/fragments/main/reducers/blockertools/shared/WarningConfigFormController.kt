package com.refayatul.fityah.ui.fragments.main.reducers.blockertools.shared
...
import com.refayatul.fityah.databinding.FragmentWarningConfigBinding
...
internal class WarningConfigFormController(
    ...
    fun bind(
        ...
        binding.trustedContactSwitch.isChecked = config.isTrustedContactUnlockEnabled
    }
    ...
    fun createConfig(
        ...
        return AppBlockerWarningScreenConfig(
            ...
            isTrustedContactUnlockEnabled = binding.trustedContactSwitch.isChecked
        )
    }
    ...
    fun validate(): Boolean {
        ...
        if (binding.trustedContactSwitch.isChecked) {
            val settings = runBlocking { 
                com.refayatul.fityah.utils.DataStoreManager(fragment.requireContext()).settings.first() 
            }
            if (settings.trustedContactName.isNullOrEmpty()) {
                Toast.makeText(fragment.requireContext(), R.string.trusted_contact_not_set_error, Toast.LENGTH_LONG).show()
                return false
            }
        }
