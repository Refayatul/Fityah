package com.refayatul.fityah.ui.fragments.main
...
import com.refayatul.fityah.data.sync.SyncGateway
import com.refayatul.fityah.databinding.FragmentInfoBinding
import com.refayatul.fityah.ui.activity.FragmentActivity
import com.refayatul.fityah.ui.fragments.main.reducers.sync.SyncFragment
import com.refayatul.fityah.utils.LanguageUtils
...
class InfoFragment : Fragment() {
    ...
    private fun setupClickListeners() {
        binding.btnDocs.setOnClickListener {
            openUrl("https://fityah.app/docs/")
        }

        binding.btnSupport.setOnClickListener {
            openUrl("https://github.com/Refayatul")
        }

        binding.btnDonate.setOnClickListener {
            openUrl("https://fityah.app/donate")
        }
        ...
        binding.cardInstagram.setOnClickListener {
            openUrl("https://instagram.com/fityah.app")
        }

        binding.cardGithub.setOnClickListener {
            openUrl("https://github.com/Refayatul/Fityah")
        }

        binding.cardBrowserExtension.setOnClickListener {
            openUrl("https://github.com/Refayatul/fityah-extension")
        }
    ...
    private fun shareProject() {
        val intent = Intent(Intent.ACTION_SEND).apply {
            type = "text/plain"
            putExtra(Intent.EXTRA_TEXT, getString(R.string.share_fityah_message))
        }
    ...
    private fun shareCrashLogs(content: String) {
        ...
        val intent = Intent(Intent.ACTION_SEND).apply {
            type = "text/plain"
            putExtra(Intent.EXTRA_SUBJECT, "Fityah Crash Logs")
